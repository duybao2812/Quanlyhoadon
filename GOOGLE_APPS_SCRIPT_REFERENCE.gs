...
function doPost(e) {
  try {
    ...
    - "BB_VT" (Vật tư): Nếu có "Thép", "Bê tông", "Xi măng", "Nhũ tương", "Vật liệu", "Cát", "Đá"...
    - "BB_CM" (Ca máy): Nếu có "Xe", "Máy xúc", "Máy ủi", "Ca máy", "Thuê máy", "Vận chuyển"...
    - "BB_TC" (Thi công): Nếu có "Thi công", "Nghiệm thu", "Khối lượng HT", "Giá trị hoàn thành"...
    - Mặc định là "BB_VT".
